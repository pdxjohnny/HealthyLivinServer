...
public class DLL implements List {
    ...
    public Object[] toArray() {
        ...
        head.toArrayRecursive(asArray, 0);
        return asArray;
    }

    private void toArrayRecursive(Object[] asArray, int index) {
        asArray[index] = data;
        if (next == null) {
            return;
        }
        next.toArrayRecursive(asArray, ++index);
    }
    ...
    public boolean remove(Object o) {
        return head.removeRecursive(o);
    }

    private boolean removeRecursive(Object o) {
        if (data == null) {
            return false;
        }
        if (data.equals(o)) {
        ...
        return next != null && next.removeRecursive(o);
    }
    ...
    private Object getRecursive(int target, int index) {
        ...
        return next.getRecursive(target, ++index);
    }
    ...
    private Object setRecursive(int target, int index, Object element) {
        ...
        return next.setRecursive(target, ++index, element);
    }
    ...
    private Object removeRecursive(int target, int index) {
        ...
        return next.removeRecursive(target, ++index);
    }
    ...
    public int indexOf(Object o) {
        return head.indexOfRecursive(o, 0);
    }
    ...
    private int indexOfRecursive(Object o, int index) {
        ...
        return next.indexOfRecursive(o, ++index);
    }
